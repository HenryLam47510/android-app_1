  ...
  void _deleteVideo() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "Bạn có chắc chắn muốn xóa video này và toàn bộ dữ liệu liên quan?",
        ),
        actions: [
          TextButton(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Trạng thái: ${widget.video.status.toUpperCase()}",
                    style: TextStyle(
                      color: widget.video.status == "processed"
                          ? Colors.green
                          : Colors.orange,
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "${widget.video.segments.length} đoạn",
                        style: const TextStyle(color: Colors.grey),
                      ),
                    ],
                  ),
                  const SizedBox(height: 12),
                  ...widget.video.segments.map(
                    (seg) => ListTile(
